...
public class ConnectionPool {
	...
	static {
		ResourceBundle bundle = PropertyResourceBundle.getBundle("dao.db");
		...
		try {
			connectionPool = new ConnectionPool(driver, jdbcURL, username, password, preconnectCount,
	...
	protected ConnectionPool(String aDriver, String aJdbcURL, String aUsername, String aPassword, int aPreconnectCount,
			int aMaxIdleConnections, int aMaxConnections) throws ClassNotFoundException, SQLException {
